...
# You should start to see reasonable images after ~5 epochs, and
# good images by ~15 epochs. You should use a GPU, as the convolution-heavy
# operations are very slow on the CPU. Prefer the TensorFlow backend if you
# plan on iterating, as the compilation time can be a blocker using Theano.
...
# Consult Auxiliary Classifier Generative Adversarial Networks in Keras for
# more information and example output.
# url: https://github.com/lukedeo/keras-acgan
