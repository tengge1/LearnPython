...
# distributed random sequence of length = input_len, and the output is a moving average of
# the input with window length = tsteps. Both input_len and tsteps are defined in the
